...
export default function Footer() {
  ...
  return (
    // Wrapper div dengan class "relative"
    <div className="relative">
      {/* Komponen Container untuk membatasi lebar dan memberikan padding */}
      <Container>
        {/* Grid untuk menyusun bagian-bagian footer */}
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          {/* Bagian Logo dan Deskripsi */}
          <div className="lg:col-span-2">
            <div>
              {/* Link dengan logo dan teks SIMONHIDRO */}
            ...
            {/* Deskripsi singkat Simonhidro */}
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Simonhidro merupakan sistem monitoring pertanian hidroponik berbasis website
