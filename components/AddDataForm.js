...
const AddForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newData = { ...formData, tanggal: currentDate };
    ...
    <div>
        ...
        <div class="grid md:grid-cols-2 md:gap-6 mt-6">
          <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                type="text" 
                name="suhu" 
                id="suhu" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" 
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5 group">
                ...
                type="text" 
                name="pH" 
                id="pH" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" 
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input
                type="text"
                name="ec" id="ec" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" 
                value={formData.ec}
                onChange={handleChange}
                placeholder=" " required />
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                onChange={handleChange}
                placeholder=" " required />
                <label for="warnadaun" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Warna daun</label>
            </div>
        </div>
